// src/app/saved/SavedEventsClient.js
"use client";
        ...
        <main className="max-w-6xl mx-auto px-4 pt-24 pb-12 space-y-20">
                    ...
                    <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
                        {events.map(ev => (
                            ...
                            >
                                <button
                                    onClick={() =>
                                        toggleFavorite(ev.event_id, ev.user_favorite)
                                    }
                                    title={
                                        ev.user_favorite
                                            ? "Remove favourite"
            ...
            <section>
                ...
                {!efLoad && efRows.length === 0 && (
                    <p className="text-center">No Eventfinda events saved yet.</p>
                )}
                            ...
                            >
                                ...
                                <div className="p-5 flex flex-col flex-1">
                                    ...
                                    <p className="mt-1 text-sm text-gray-600">
                                        ...
                                        {ev.datetime_end && <> – {fmtDT(ev.datetime_end)}</>}
                                    </p>
